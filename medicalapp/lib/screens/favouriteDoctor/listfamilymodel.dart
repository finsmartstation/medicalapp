...
class ListFavouriteFamilyDoctors {
    ...
    factory ListFavouriteFamilyDoctors.fromRawJson(String str) => ListFavouriteFamilyDoctors.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ListFavouriteFamilyDoctors.fromJson(Map<String, dynamic> json) => ListFavouriteFamilyDoctors(
        status: json["status"],
        statuscode: json["statuscode"],
        familyDoctor: Doctor.fromJson(json["family_doctor"]),
        favouriteDoctor: List<Doctor>.from(json["favourite_doctor"].map((x) => Doctor.fromJson(x))),
        recentDoctor: List<RecentDoctor>.from(json["recent_doctor"].map((x) => RecentDoctor.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "favourite_doctor": List<dynamic>.from(favouriteDoctor.map((x) => x.toJson())),
        "recent_doctor": List<dynamic>.from(recentDoctor.map((x) => x.toJson())),
...
class RecentDoctor {
    ...
    factory RecentDoctor.fromRawJson(String str) => RecentDoctor.fromJson(json.decode(str));
