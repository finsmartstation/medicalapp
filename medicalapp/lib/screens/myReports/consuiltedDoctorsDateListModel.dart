...
class ConsultedDoctorsDateList {
  ...
  factory ConsultedDoctorsDateList.fromRawJson(String str) =>
      ConsultedDoctorsDateList.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ConsultedDoctorsDateList.fromJson(Map<String, dynamic> json) =>
      ConsultedDoctorsDateList(
        status: json["status"],
